...
<header class="bg-gradient-to-r from-blue-500 to-blue-700 text-white py-4 shadow-md">
    <div class="container mx-auto flex justify-between items-center px-4">
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-2xl font-bold">{{ __('general.pars_support_system') }}</h1>
        </div>
        <div>
            <a href="/login" class="text-sm bg-white text-blue-600 py-2 px-4 rounded shadow hover:bg-gray-200">{{ __('general.login') }}</a>
...
<section class="bg-white py-16">
    <div class="container mx-auto flex flex-col md:flex-row items-center px-4">
        <div class="md:w-1/2 text-center md:text-right">
            <h2 class="text-4xl font-bold text-gray-800">به سامانه پشتیبانی مشتریان خوش آمدید</h2>
...
<section class="bg-gray-50 py-12">
    <div class="container mx-auto text-center px-4">
        ...
        <p class="text-gray-600 mt-2">با استفاده از سامانه پشتیبانی مشتریان، درخواست‌های خود را به راحتی مدیریت کنید.</p>
...
<footer class="bg-gray-800 text-white py-6 mt-12">
    <div class="text-center text-sm mt-4">&copy; 1403 سامانه پشتیبانی مشتریان. کلیه حقوق محفوظ است.</div>
</footer>
</body>
</html>
